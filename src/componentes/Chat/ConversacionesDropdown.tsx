  ...
  return (
    ...
    >
      {loading ? (
        ...
        <div className="p-3 text-center text-muted">Sin conversaciones</div>
      ) : (
        conversaciones.map((c) => (
          ...
          >
            ...
            <div className="flex-grow-1">
              <div className="fw-semibold">{c.nombreOtraPersona}</div>
              <div
            ...
            {c.noLeidos > 0 && (
              <span className="badge bg-danger ms-2">{c.noLeidos}</span>
            )}
          </div>
        ))
      )}
